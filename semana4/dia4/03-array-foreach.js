...
//====================================//
//===================================================================================
// prompt >> (Aqui enviaremos un mensaje en la ventana emergente, Aqui enviaremos un mensaje en el casilla de texto) 
//
// forEach >> sirve para recorrer un arreglo sin necesidad de usar un ciclo for.
//         >> recibe una función anónima la se cual ejecutará tantas veces como 
//            elementos tenga muestro arreglo
...
console.table(lenguajes[1]);

//====================================================================================

console.log(nombres.length);

var elemento = parseInt(prompt("Qué elemento del array quieres: ", "piensa animal"));
...
var busqueda1 = lenguajes.find(lenguaje => lenguaje == "Fortran");
