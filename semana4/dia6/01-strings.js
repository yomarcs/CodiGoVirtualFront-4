...
// <!----------- FrontEnd - JavaScript ------------>
// <!-- ---------------------------------------- -->
// <!---- Video 22 - String y sus propiedades ----->
//===================================================================================
// >> string.length -> calcula longitud de un texto o tamaño de caracteres de una cadena. 
//                  -> util para comprobar si una variables tiene texto o si viene vacia.
// >> string.toLowerCase() -> retorna la misma cadena con todos sus caracteres en minúsculas.
//                         -> ojo: no transforma la cadena inicial.
// >> string.toUpperCase() -> retorna la misma cadena con todos sus caracteres en mayúsculas
//                         -> OJO: no transforma la cadena inicial.
// >> toString() -> convierte cualquier tipo de dato a String.
// >> string[posicion] -> Se puede manejar a un string como un arreglo es decir, podemos 
//                        acceder a sus posiciones con un valor numérico.
// string.substr(pos.inicial, cant.caracteres) -> retorna una sub-cadena desde la posicion_inicial,
//                                                se cuenta una cantidad_de_caracteres a la derecha.
// string.includes("cadena") -> Retorna true si es que la cadena pasada por parámetros está dentro de
//                              la cadena completa, y false, si la cadena no es parte de la frase completa
// string.indexOf("cadena",opcional_posicion_inicial) -> Retorna la posición en la que la "cadena" inicia
//                                                       dentro de la frase, en caso de que no exista 
//                                                       dicha sub-cadena, retorna -1
//                                                    -> OPCIONALMENTE: si se envía un segundo parametro
//                                                       (opcional_posicion_inicial) la subcadena se
//                                                       busca desde la posicón de dicho parametro.
...
// >> string.concat() -> Tiene la misma funcion que el operador "+" y permite concatenar
...
// retorna una subcadena desde la posicion_inciial hasta un caracter 
