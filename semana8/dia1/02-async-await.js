...
//<----------- async - await ---------->
//<--=================================================-->
// >> las funciones async (asíncronas) tienen
//    la posibilidad de hacer síncronas varías
//    tareas asíncronas en su interior.
// >> Toda función async (asíncrona) en su
//    apartado "return", retorna una promesa.
// >> Si deseamos usar la palabra reservada "await",
//    la función contenedora debe ser "async"(asincrona).
//<--=================================================-->
