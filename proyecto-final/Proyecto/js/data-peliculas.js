const peliculas = [{
    ...
    },
    {
        ...
        vote_average: 6.6,
        overview: "En un futuro no muy lejano, el Gobierno de los Estados Unidos planea activar una señal para detener todo comportamiento delictivo. Un ladrón se suma a un plan para dar el último golpe que pasará a la historia.",
    ...
    },
    {
        ...
        title: "Beckman",
        vote_average: 6,
        overview: "Un asesino a sueldo, se convierte en reverendo de una iglesia de Los Ángeles, hasta que un líder de una secta y sus secuaces secuestran a su hija. Cegado por la venganza, abre un camino sangriento a través de la ciudad. Lo único que puede detenerlo es su nueva fe.",
