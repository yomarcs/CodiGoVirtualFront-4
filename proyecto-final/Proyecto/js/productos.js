...
formProducto.onsubmit = (e) => {
    ...
    if (modo === "crear") {
        ...
        let objProducto = {
            ...
            producto_tipo: selectTipo.value,
            producto_marca: selectMarca.value,
            producto_stock: inputStock.value,
            producto_precio: inputPrecio.value,
            producto_precioPromocion: inputPrecioPromocion.value,
            producto_descripcion: textDescripcion.value,
        };
...
const modoEditar = (producto) => {
    ...
    // ======================================================================
    selectCategoria.options[productoGlobal.producto_categoria].selected;
