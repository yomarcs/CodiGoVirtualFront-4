...
//<!-------------- Eventos ------------>
//<!--==============================--->
// >> Los eventos son sucesos que ocurren cuando un elemento es afectado por 
//    una acción, Ejm: click, pasar el mouse por encima, presionar una tecla,
//    manter el click presionado, escribir algo sobre el elemento(input), etc.
//
...
btn2.onclick = (evento) => {
    ...
    // >> evento.altKey -> retorna true si el evento ha sido ejecutado con la ayuda de la tecla ALT,
