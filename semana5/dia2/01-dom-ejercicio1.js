...
// Función que agrega mediante un string todos los links de la lista.
const llenarLinks = () => {
    let stringLinks = "";
    links.forEach((link) => {
...
const llenarUsuarios = () => {
    ...
    usuarios.forEach((usu) => {
            //3. en cada iteración sumar al string del paso 1, un tr con 5 td's con la data del objeto usuario.
            filas = filas + `<tr>
